 ...
 * </pre>
 */
public class UserAppAccountPanel extends UserAttrInfoPanel {
	...
	private UserAppAccountPanel userAppAccountPanel;
	public UserAppAccountPanel getUserAppAccountPanel()
	{
		return this.userAppAccountPanel;
	}
	
	public void setUserAppAccountPanel(UserAppAccountPanel userAppAccountPanel)
	{
	 ...
	 *            资源类别
	 */
	public UserAppAccountPanel(String id,List<Attribute> attrList,String catagory) {
		super(id);
	 ...
	 *            资源类别
	 */
	public UserAppAccountPanel(String id, User user, String catagory) {
		super(id);
		...
		init(id,attrList, catagory);
//		userAppAccountPanel = new UserAppAccountPanel("attr1", attrList,
//				catagory);
