...
<html xmlns="http://www.w3.org/1999/xhtml">
 <head>
	...
	.content_3{ float:left; width:120px; height:150px; background:url(${ctx}/heaconsole/images/warning.jpg) no-repeat center right;}
	</style>
  </head>
  <body>
  <div class="warningbox">
    ...
    <div class="content_2">应用程序升级中，请稍后访问...    </div>
    <!-- 
