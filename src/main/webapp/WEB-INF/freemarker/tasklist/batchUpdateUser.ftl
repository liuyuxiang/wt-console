...
<form name="user" id="user" method="post" enctype="multipart/form-data" action='<@spring.url "/tasklist/batchUpdateUser.nsf" />'>
		...
		<TD  align=left colspan="3"  bgcolor="#fffff0">
		   <a href="<@spring.url "/tasklist/downloadusertemp.nsf" />?typeflag=update">更新用户模版</a>
		</TD>
		</tr>
