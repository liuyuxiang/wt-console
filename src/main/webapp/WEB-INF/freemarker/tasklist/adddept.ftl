...
<form name="dept" id="dept" method="post" enctype="multipart/form-data" action="<@spring.url "/tasklist/adddept.nsf" />">
		...
		<TD  align=left colspan="3"  bgcolor="#fffff0">
		   <a href="<@spring.url "/tasklist/downloaddepttemp.nsf" />">新增部门模版</a>
		</TD>
		</tr>
