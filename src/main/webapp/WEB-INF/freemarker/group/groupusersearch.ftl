...
function chkall(input1,input2,name)
{
 ...
 $(function(){
     $("#pagesizego").click(function(){
         var pagesizegovalue=$("#pagesizegovalue").val();
          var searchvalue=$("#searchType").val();
             f1.action="<@spring.url "/group/groupusersearch.nsf" />?id=${groupChildren.uuid}&pagesize="+pagesizegovalue+"&searchvalue="+searchvalue;
             $("#f1").submit();
    ...
    $(function(){
     $("#pagego").click(function(){
           ...
           var pagesizegovalue=$("#pagesizegovalue").val();
            var searchvalue=$("#searchType").val();
            f1.action="<@spring.url "/group/groupusersearch.nsf" />?id=${groupChildren.uuid}&page="+pagegovalue+"&pagesize="+pagesizegovalue+"&searchvalue="+searchvalue;
  	        $("#f1").submit();
  	});
  });
      $(function(){
     $("#home").click(function(){
           ...
           var pagesizegovalue=$("#pagesizegovalue").val();
            var searchvalue=$("#searchType").val();
            f1.action="<@spring.url "/group/groupusersearch.nsf" />?id=${groupChildren.uuid}&page=1&pagesize="+pagesizegovalue+"&searchvalue="+searchvalue;
  	        $("#f1").submit();
  	});
  });
    $(function(){
     $("#last").click(function(){
           ...
           var pagesizegovalue=$("#pagesizegovalue").val();
            var searchvalue=$("#searchType").val();
            f1.action="<@spring.url "/group/groupusersearch.nsf"/>?id=${groupChildren.uuid}&page=${javapage.getLastPage()}&pagesize="+pagesizegovalue+"&searchvalue="+searchvalue;
  	        $("#f1").submit();
  	});
  });
      $(function(){
     $("#previous").click(function(){
           ...
           var pagesizegovalue=$("#pagesizegovalue").val();
            var searchvalue=$("#searchType").val();
            f1.action="<@spring.url "/group/groupusersearch.nsf"/>?id=${groupChildren.uuid}&page=${javapage.getPreviousPage()}&pagesize="+pagesizegovalue+"&searchvalue="+searchvalue;
  	        $("#f1").submit();
  	});
  });
       $(function(){
     $("#next").click(function(){
           ...
           var pagesizegovalue=$("#pagesizegovalue").val();
            var searchvalue=$("#searchType").val();
            f1.action="<@spring.url "/group/groupusersearch.nsf"/>?id=${groupChildren.uuid}&page=${javapage.getNextPage()}&pagesize="+pagesizegovalue+"&searchvalue="+searchvalue;
  	        $("#f1").submit();
  	});
  });
      $(function(){
     $("#addusertoadmingroup").click(function(){
			 ...
			 if(a!=null){ var valueStr="";
              ...
              if   (a[i].checked) {
                ...
                if(valueStr.length>0){
			            ...
			            var pagesizegovalue=$("#pagesizegovalue").val();
			            var searchvalue=$("#searchType").val();
			            f1.action="<@spring.url "/adduserstoadmingroup.nsf" />?id=${groupChildren.uuid}&page=1&pagesize="+pagesizegovalue+"&searchvalue="+searchvalue+"&userids="+valueStr;
			  	        $("#f1").submit();
                 }else{
                  alert("至少选择一个！");
                }
 ...
 $(function(){
     $("#deluserstoadmingroup").click(function(){
			 ...
			 if(a!=null){ var valueStr="";
              ...
              if   (a[i].checked) {
                ...
                if(valueStr.length>0){
			            ...
			            var pagesizegovalue=$("#pagesizegovalue").val();
			            var searchvalue=$("#searchType").val();
			            f1.action="<@spring.url "/deluserstoadmingroup.nsf" />?id=${groupChildren.uuid}&page=1&pagesize="+pagesizegovalue+"&searchvalue="+searchvalue+"&userids="+valueStr;
			  	        $("#f1").submit();
                 }else{
                  alert("至少选择一个！");
                }
                ...
                <tr>
                    ...
                    <table id="table1" border="0" cellspacing="0" align="center"
                        ...
                        <tr style="background-color:#DAE9F9;font-size:12px;"> 
                            <td height="18" width="22%">&nbsp;搜索结果&nbsp; </td>
                            <td><input  class="button" type="button" id="backgroup" value="返回【${groupChildren.name}】列表" ></td>
                            ...
                            <input type="text"  name="searchcontent" id="searchcontent" size="10" onkeypress="checkEventName();" value="${searchcontent}">  
							 ...
							 <input  type="button" class="button"  id="searchSubmit" value="搜  索" >
							  <input  class="button" type="button" id="addusertoadmingroup"  value="加  入"  >
							  <input  class="button" type="button" id="deluserstoadmingroup"  value="移  除"  >
							 </td>
                        </tr>
                        <tr>
                            <td colspan="4">
                            <table width="100%"  id="table1" border=1px; cellspacing="0" cellpadding="0" bordercolordark="#FFFFFF" >
                                <tr style="background-image:url(<@spring.url "/style/default/images/title_bg.gif" />);">
                                    ...
                                    <td align="center" width="15%" bgcolor="#97C6DF"><font color="#000000">姓名</font>
                                    </td>                                    
                                    <td align="center" bgcolor="#97C6DF"><font color="#000000">排序号</font>
                                    </td>
                                    </#if>
                                    <td align="center" width="40%" bgcolor="#97C6DF"><font color="#000000">所在管理组</font>
                                    </td>
	                               ...
	                               <#if  userlist ?? >
									<#list userlist as user>
	                                    ...
	                                    <td  width="5%">
	                                   <#if    uumService.existUserManagerUnderGroup(groupChildren,user)  >
	                                                                                                    已加入
	                                    <#else>
	                                    <input type="checkbox" value="${user.uuid}" id="moveusers" name="moveusers" onclick="subchick1(this)">
	                                    </#if>
	                                    </td>
	                                    <td width="5%">
	                                    <#if    uumService.existUserManagerUnderGroup(groupChildren,user) >
	                                    <input type="checkbox" value="${user.uuid}" id="delusers" name="delusers" onclick="subchick2(this)">
	                                    </#if></td>
									</tr>
									</#list>
									</#if>
