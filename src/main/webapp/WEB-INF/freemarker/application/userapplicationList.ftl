  ...
  $(function(){
     $("#searchSubmit").click(function(){
             ...
             if(searchcontent.length>0){
               f1.action='<@spring.url "/application/userapplicationSearch.nsf" />?id=${application.uuid}&searchvalue='+searchvalue;
               $("#f1").submit();
               }else{
                alert("请输入查询内容!");
              }
											...
											<table width="100%" style="background-color:#DAE9F9;font-size:12px;">
												<tr>
													...
													<td height="21" align="right" width="18%">
														<input id="movegroupuser" type="button" class="button"  value="解绑" >
													</td>
												</tr>
											</table>
									</td>
