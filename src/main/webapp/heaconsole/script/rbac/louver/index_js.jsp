    ...
    function clickTitleBtn(indexId,divNum){
    	...
    	for(var i = 0;i < 30;i++){
    		...
    		if(divMenu == null){
	    		...
	    		divMenu.className = 'mainnav_menu';
    		}
    	...
    	document.getElementById('divMenu_' + divNum).className = 'mainnav_menucurrent';
     ...
     function buildTree(rootId,divNum){
		...
		tree.setImagePath("${pageContext.request.contextPath}/common/images/theme/${sessionScope.theme}/component/dhtmlxtree/");
     ...
     function showHideMenu(show_Int){
         if(showHideMenuInit == 1){
         	showHideMenuInit = 0;
         	siderbarWidth = $(".siderbar").width() + $(".drawback").width();
         }
     	if(show_Int != null)
     		isShowMenu = show_Int;
     	else
