...
$(document).ready(function() {
	...
	tree1.setImagePath("${pageContext.request.contextPath}/common/component/dhtmlxtree/images/");
	...
	tree2.setImagePath("${pageContext.request.contextPath}/common/component/dhtmlxtree/images/");
